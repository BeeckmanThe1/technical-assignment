export const correctLauchesApiResponse = {
    "data": {
        "docs": [
            {
                "fairings": {
    ...
    "headers": {
        ...
        "spacex-api-cache": "MISS",
        "spacex-api-response-time": "11ms"
    },
    "config": {
        "url": "https://api.spacexdata.com/v4/launches/query",
        "method": "post",
        "data": "{\"query\":{\"success\":false,\"launchpad\":\"5e9e4502f5090995de566f86\"},\"options\":{\"populate\":[{\"path\":\"launchpad\",\"select\":{\"name\":1}}],\"sort\":{\"date_unix\":\"desc\"}}}",
        "headers": {
...
export const correctlyReducedLaunchesData = {
